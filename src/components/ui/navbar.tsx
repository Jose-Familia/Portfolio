...
const icons = [
  ...
  { href: "https://github.com/Jose-Familia", Icon: Github, label: "GitHub", isExternal: true },
  { href: "https://www.linkedin.com/in/jrfamilia", Icon: Linkedin, label: "LinkedIn", isExternal: true },
  { href: "mailto:familiajoserene@gmail.com", Icon: Mail, label: "Email", isExternal: true },
]
...
export default function NavBar() {
  ...
  return (
    ...
    >
      <motion.div
        className={`mx-auto w-max flex items-center justify-center space-x-1 rounded-full shadow-lg px-4 py-2 backdrop-blur-md ${
